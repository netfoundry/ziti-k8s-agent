...
func (in *ZitiWebhookSpec) DeepCopyInto(out *ZitiWebhookSpec) {
	*out = *in
	...
	if in.ClusterRoleSpec != nil {
		in, out := &in.ClusterRoleSpec, &out.ClusterRoleSpec
		*out = make([]ClusterRoleSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ClusterRoleBindingSpec != nil {
		in, out := &in.ClusterRoleBindingSpec, &out.ClusterRoleBindingSpec
		*out = make([]ClusterRoleBindingSpec, len(*in))
		copy(*out, *in)
	}
}
